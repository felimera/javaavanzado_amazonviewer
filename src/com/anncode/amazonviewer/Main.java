...
//					exit = 1;
	...
	/*
	 * public static void makeReport(Date date) { SimpleDateFormat df = new
	 * SimpleDateFormat("yyyy-MM-dd-h-m-s-S"); String dateString = df.format(date);
	 * Report report = new Report();
	 * 
	 * report.setNameFile("reporte" + dateString); report.setExtension("txt");
	 * report.setTitle(":: VISTOS ::");
	 * 
	 * 
	 * SimpleDateFormat dfNameDays = new SimpleDateFormat("E, W MMM Y"); dateString
	 * = dfNameDays.format(date); String contentReport = "Date: " + dateString +
	 * "\n\n\n";
	 * 
	 * for (Movie movie : movies) { if (movie.getIsViewed()) { contentReport +=
	 * movie.toString() + "\n";
